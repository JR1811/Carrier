...
public class CarriableSpawner extends CarriableGeneric {
    ...
    public MobSpawnerBlockEntity getEntity() {
        if (dummySpawner == null)
            dummySpawner = new MobSpawnerBlockEntity(BlockPos.ORIGIN, parent.getDefaultState());
        return dummySpawner;
    }
    ...
    public MobSpawnerBlockEntityRenderer getEntityRenderer() {
        if (dummyRenderer == null)
            dummyRenderer = new MobSpawnerBlockEntityRenderer(ClientUtils.defaultBlockCtx());
